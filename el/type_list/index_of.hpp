	...
	namespace el {
		namespace impl {
			...
			constexpr auto index_of(el::size_c<Idx> idx, el::Type_c<el::type_list_t<T, TRest...>>, int = 0) noexcept {
				return idx;
			}

			template<typename T, std::size_t Idx>
			constexpr auto index_of(el::size_c<Idx>, el::Type_c<el::type_list_t<>>, int = 0) noexcept {
				return el::false_c{};
			}

			template<typename T, std::size_t Idx, typename THead, typename ...TRest>
			constexpr auto index_of(el::size_c<Idx>, el::Type_c<el::type_list_t<THead, TRest...>>, ...) noexcept {
